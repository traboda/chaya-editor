...
const getMenuCommands = (editor: Editor, commandNames: MenuCommands[]) => {
  ...
  const COMMANDS_LIST: MenuCommandConfig<MenuCommands>[] = [
    ...
    },
    {
      ...
      icon: 'ri-align-left',
      label: 'Left Align',
      isActive: (editor) => editor.isActive('paragraph') && editor.isActive({ textAlign: 'left' }),
    ...
    },
    {
      ...
      label: 'Center Align',
      isActive: (editor) => editor.isActive('paragraph') && editor.isActive({ textAlign: 'center' }),
    ...
    },
    {
      ...
      icon: 'ri-align-right',
      label: 'Right Align',
      isActive: (editor) => editor.isActive('paragraph') && editor.isActive({ textAlign: 'right' }),
