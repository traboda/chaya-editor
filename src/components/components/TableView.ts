...
export class TableView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, cellMinWidth: number) {
    ...
    this.dom.className = 'chaya-editor-table';
    this.wrapper = document.createElement('div');
    this.wrapper.className = 'chaya-editor-table-wrapper';
    this.table = this.dom
    ...
    this.wrapper.appendChild(
      this.buildController({
        className: 'chaya-editor-table-add-column',
    ...
    this.dom.appendChild(
      this.buildController({
        className: 'chaya-editor-table-add-row',
  ...
  buildController = ({ className = '', handleClick = () => {} }) => {
